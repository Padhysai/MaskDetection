...
class MultiClassObj:
    def __init__(self, imagePath, modelPath):
        ...
        self.PATH_TO_CKPT = os.path.join(CWD_PATH, self.MODEL_NAME, 'mask_frozen_inference_graph.pb')
        # Path to label map file
        self.PATH_TO_LABELS = os.path.join(CWD_PATH, 'research/data', 'mask_labelmap.pbtxt')
